            ...
            <div className="mt-10 flex flex-col md:flex-row items-start">
                ...
                <div className="w-full md:w-1/2 flex flex-wrap gap-3 sm:ml-3 mt-3 sm:mt-0">
                    {props.borders.map((country, index) => (
                        <div className="inline-block min-w-[100px] shadow-lg rounded-sm bg-lightElements dark:bg-metus-100 text-center text-sm py-1 px-2 hover:bg-gray-200 dark:hover:brightness-125 transition-all">
                            {country}
                        </div>
                    ))}
                </div>
