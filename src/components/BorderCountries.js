    ...
    return (
        props.borders && (
            <div className="mt-10 flex flex-col md:flex-row items-start">
                <span className="flex md:min-w-[140px] mr-4 mb-4 w-full text-base font-bold sm:w-auto mb-2">Border Countries:</span>
                <div className="flex flex-wrap gap-3 sm:ml-3 mt-3 sm:mt-0">
